<template>
  <div class="slide-toolbar">
    <div class="remark">
      <textarea
        :value="remark"
        :placeholder="$t('mobileSlideToolbar.remarkPlaceholder')"
    ...
    <div class="toolbar">
      <ButtonGroup class="row">
        ...
        <Button style="flex: 1;" @click="copyAndPasteSlide()"><IconCopy class="icon" /> {{ $t('mobile.copy') }}</Button>
        <Button style="flex: 1;" @click="deleteSlide()"><IconDelete class="icon" /> {{ $t('mobile.delete') }}</Button>
      </ButtonGroup>
      <ButtonGroup class="row">
        ...
        <Button style="flex: 1;" @click="insertShapeElement('square')"><IconSquare class="icon" /> {{ $t('mobile.rectangle') }}</Button>
...
const insertTextElement = () => {
  ...
  createTextElement({
    ...
    width,
    height,
  }, { content: `<p>${t('mobile.newTextContent')}</p>` })
}
