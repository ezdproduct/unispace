<template>
  <div class="mobile-preview" ref="mobileRef">
    ...
    <div class="menu">
      <div class="menu-item" @click="changeMode('editor')"><IconEdit class="icon" /> {{ $t('mobile.edit') }}</div>
      <Divider type="vertical" style="height: 30px;" />
      <div class="menu-item" @click="changeMode('player')"><IconFullScreenPlay class="icon" /> {{ $t('mobile.play') }}</div>
      <Divider type="vertical" style="height: 30px;" />
