<template>
  ...
  >
    <div class="header">
      <span class="text-btn" @click="toggle()">{{ inTiming ? $t('screening.pause') : $t('screening.start') }}</span>
      <span class="text-btn" @click="reset()">{{ $t('screening.reset') }}</span>
      <span class="text-btn" @click="toggleCountdown()" :class="{ 'active': isCountdown }">{{ $t('screening.countdown') }}</span>
    </div>
    <div class="content">
      <div class="timer">
        <input 
