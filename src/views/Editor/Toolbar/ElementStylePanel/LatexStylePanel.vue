<template>
  <div class="latex-style-panel">
    <div class="row">
      <Button style="flex: 1;" @click="latexEditorVisible = true"><IconEdit /> {{ $t('toolbar.editLatex') }}</Button>
    </div>

    <Divider />

    <div class="row">
      <div style="width: 40%;">{{ $t('toolbar.color') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('toolbar.strokeWidth') }}：</div>
      <NumberInput 
        :min="1"
        :max="3"
