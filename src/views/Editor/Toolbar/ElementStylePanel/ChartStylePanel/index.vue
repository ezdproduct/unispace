<template>
  <div class="chart-style-panel">
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('toolbar.backgroundFill') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('toolbar.coordAndText') }}：</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('toolbar.gridColor') }}：</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('toolbar.themeColors') }}：</div>
      <Popover trigger="click" v-model:value="themesVisible" style="width: 60%;">
        <template #content>
          <div class="themes">
            <div class="label">{{ $t('toolbar.presetChartThemes') }}：</div>
            ...
            <div class="label">{{ $t('toolbar.slideTheme') }}：</div>
            ...
            <Divider :margin="10" />
            <Button class="full-width-btn" @click="themesVisible = false; themeColorsSettingVisible = true">{{ $t('toolbar.customColors') }}</Button>
          </div>
        </template>
